...
image: /assets/images/posts/sql/001-title.jpeg
...
This challenge was created by *[Dawn Choo](https://www.linkedin.com/in/data-dawn/){:target="_blank" rel="noopener"}*, a renowned data scientist with over 90,000 followers on LinkedIn. Be sure to follow her for some fantastic resources and insights! 

> Unfortunately, the challenge was closed in January, so it's no longer available for practice.
...
![challenge finishing screenshot](/assets/images/posts/sql/001-01-congrats.png){: .has-caption.post-img.has-border.ml-auto.mr-auto}
{: data-caption="Figure: Challenge finishing message"}
