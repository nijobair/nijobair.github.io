...
Vega provides a collection of sample datasets in various formats that are perfect for learning and experimenting. You can explore them [here](https://cdn.jsdelivr.net/npm/vega-datasets@3.1.0/data/). To use any of these datasets, just set the `url` like this: `"https://cdn.jsdelivr.net/npm/vega-datasets@3.1.0/data/<datasetName.format>"`. Replace `<datasetName.format>` with the actual name and format of the dataset you want to use.
